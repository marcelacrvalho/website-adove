const autocomplete = document.getElementById("complete");
...
const data = [
  ...
  "Nova Canãa do Norte, Mato Grosso",
  ...
  "Santa Cruz Monte Castelo, Paraná",
  "Santa Fé, Paraná",
  "Santa Helena, Paraná",
  "Santa Inês, Paraná",
  ...
  "São Miguel de Touros, Rio Grande do Norte",
  ...
  "Alto Alegre do Parecis, Rondônia",
  ...
  "Benjamin Constan do Sul, Rio Grande do Sul",
  ...
  "Pântano Grande, Rio Grande do Sul",
...
function sendNavigation(location) {
  gtag('config', 'UA-225590891-1', { page_path: location });
}

autocomplete.oninput = function () {
  let results = [];
  const userInput = this.value.toLowerCase().replace(/(?:^|\s)\S/g, function (a) {
...
resultsHTML.onclick = function (event) {
  ...
  this.innerHTML = "";
  inputCity = autocomplete.value;
};

async function onClicked() {

  const endpoint = "https://adove-server.fedratecnologia.com.br";
  const headers = {
  ...
  const graphqlQuery = {
    ...
    "query": `mutation CreateStore ($name: String, $email: String, $password: String, 
        $category: String, $open: String,
    ...
    "variables": {
      ...
      "open": document.getElementById("inputOpen").value,
  ...
  window.open("https://www.mercadopago.com.br/subscriptions/checkout?preapproval_plan_id=2c9380847b629336017bd6260d545e0f",
   '_blank').focus();
